...
const Add = () => {
    ...
    return (
        <section className="p-4 sm:p-10 w-full bg-primary/20">
            <form onSubmit={onSubmiHandler} className="flex flex-col gap-y-5 max-w-[555px]">
                ...
                <div className="flex items-center gap-x-6 text-gray-900/70 medium-15">
                    ...
                    <div className="flex flex-col gap-y-2">
                        <p>Product Price</p>
                        <input className="ring-1 ring-slate-900/10 pl-2 w-24 outline-none" type="number" name="price" placeholder="$20" onChange={onChangeHandler} value={data.price} />
                    </div>
                </div>
